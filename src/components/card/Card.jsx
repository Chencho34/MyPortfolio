    ...
    <section className='w-[340px] bg-slate-50 dark:bg-[#191919] hover:shadow-lg shadow-md dark:hover:shadow-neutral-950  rounded-md transition-all duration-500 overflow-hidden '>
      ...
      <section className='px-4 py-4 flex flex-col gap-4'>
        ...
        <article className='flex gap-3'>
          ...
          <button className='flex items-center justify-evenly border border-[#242424] dark:border-gray-300  dark:text-gray-300  py-1 rounded-md text-[#242424] hover:text-gray-300 dark:hover:text-gray-700 font-semibold text-sm w-20 duration-500 transition-colors'>
            Git <FaGithub />
          </button>
        </article>
      </section>
