      ...
      <Container>
        <Fade direction='left' duration={400} >
          <article className='flex flex-col gap-4'>
            ...
            <Fade direction='left' duration={400}><button className='bg-[#161616] dark:bg-gray-300 dark:text-[#161616] rounded-sm w-28 text-white font-semibold text-sm py-1'>Resume</button></Fade>
          </article>
        </Fade>
      </Container>
    </Wrapper>
